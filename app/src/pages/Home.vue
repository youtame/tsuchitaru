<template>
  <v-container>
    <div class="hero">
      <v-img :src="logo" alt="Main Visual" class="hero-image" />
    ...
    >
      ...
      <v-col>
        <v-btn
          ...
          to="/aboutsite"
        >
          <v-icon icon="mdi-alert-outline" class="mr-2" size="large"></v-icon>
          サイト注意事項
        </v-btn></v-col
      >
    </v-row>
    <div class="start-section">
      ...
      <p class="start-intro">
        目的地まで最短経路で行くのはかんたんです。そこで、Let's
        Walkはユーザーにあった距離の運動をしたあと、路線網の発達したバスに乗って目的地に向かうことで手軽に運動できるwebアプリケーションです。
      </p>
      <v-btn
        variant="flat"
        rounded="lg"
